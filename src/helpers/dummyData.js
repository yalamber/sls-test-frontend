    ...
    id: 1, name: 'Project Manager', users: [
      {
        ...
        role: 'Manager',
        name: 'Amrit Tamang',
        address: '10th street Downtown Demo',
...
export const dashboards = [
  {
    companyId: 32,
    boardName: 'Netware 5.1 protocol',
    teamName: 'Net Driver Team',
    teamAdmin: 'Pat Holman',
    status: 'Green',
  },
  {
    companyId: 35,
    boardName: 'Active Directory',
    teamName: 'Directory Team',
    teamAdmin: 'Jim Smith',
    status: 'Green',
  },
];